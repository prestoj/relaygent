...
<style>
	...
	.cp.full { border: none; border-radius: 0; background: var(--bg); min-height: 0; max-height: none; height: 100%; margin: 0 auto; max-width: 800px; width: 100%; padding: 0 1em; box-sizing: border-box; }
