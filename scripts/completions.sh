...
_relaygent_commands="setup start stop restart status stats logs orient check health update cleanup clean-logs install-services set-password mcp archive-linear version help"
