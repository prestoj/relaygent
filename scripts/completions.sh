...
_relaygent_commands="setup start stop restart status stats test logs orient check health update cleanup clean-logs changelog install-services set-password mcp archive-linear open version help"
